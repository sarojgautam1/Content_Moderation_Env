...
TASKS = [
    ...
    TaskModel(
        ...
        expected_final_action="dismiss_report", # Because no specific health violation and fact check might be unverified
    ...
    TaskModel(
        ...
        expected_final_action="escalate_to_human", # Because user has 3 strikes! Satire exception requires escalation.
        expected_violation_code=None,
    ...
    TaskModel(
        ...
        content="I simply LOVE how our glorious Mayor is stealing our taxes to fund his personal yacht. Excellent leadership! (Satire account)",
        report_reason="Harassment / Bullying of a Public Figure",
        expected_final_action="dismiss_report", # Because it's satire and user is clean
        expected_violation_code=None,
        required_tools=["search_handbook", "request_user_history"]
    ),
    TaskModel(
